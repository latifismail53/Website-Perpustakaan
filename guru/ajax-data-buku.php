...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $nestedData[] = '<td><center>
                     ...
                     <a href = "index-guru.php?page=buku_pinjam_guru&kd='.$row['id'].'" data-toggle="tooltip" title="Pinjam" class="btn btn-sm btn-success"> <i class="menu-icon icon-shopping-cart"></i>Pinjam</a></td>';		
